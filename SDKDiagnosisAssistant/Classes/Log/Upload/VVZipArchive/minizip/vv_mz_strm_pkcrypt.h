/* vv_mz_strm_pkcrypt.h -- Code for traditional PKWARE encryption
...
#ifndef VV_MZ_STREAM_PKCRYPT_H
#define VV_MZ_STREAM_PKCRYPT_H
...
int32_t vv_mz_stream_pkcrypt_open(void *stream, const char *filename, int32_t mode);
