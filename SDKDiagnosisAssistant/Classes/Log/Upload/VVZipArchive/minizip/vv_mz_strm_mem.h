/* vv_mz_strm_mem.h -- Stream for memory access
...
#ifndef VV_MZ_STREAM_MEM_H
#define VV_MZ_STREAM_MEM_H
...
int32_t vv_mz_stream_mem_open(void *stream, const char *filename, int32_t mode);
