/* vv_mz_strm_zlib.h -- Stream for zlib inflate/deflate
...
#ifndef VV_MZ_STREAM_ZLIB_H
#define VV_MZ_STREAM_ZLIB_H
...
int32_t vv_mz_stream_zlib_open(void *stream, const char *filename, int32_t mode);
