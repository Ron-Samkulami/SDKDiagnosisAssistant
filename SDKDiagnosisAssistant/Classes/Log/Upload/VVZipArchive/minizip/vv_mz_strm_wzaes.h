/* vv_mz_strm_wzaes.h -- Stream for WinZIP AES encryption
...
#ifndef VV_MZ_STREAM_WZAES_SHA1_H
#define VV_MZ_STREAM_WZAES_SHA1_H
...
int32_t vv_mz_stream_wzaes_open(void *stream, const char *filename, int32_t mode);
