/* vv_mz_zip_rw.h -- Zip reader/writer
...
#ifndef VV_MZ_ZIP_RW_H
#define VV_MZ_ZIP_RW_H
...
typedef int32_t (*vv_mz_zip_reader_overwrite_cb)(void *handle, void *userdata, vv_mz_zip_file *file_info, const char *path);
typedef int32_t (*vv_mz_zip_reader_password_cb)(void *handle, void *userdata, vv_mz_zip_file *file_info, char *password, int32_t max_password);
typedef int32_t (*vv_mz_zip_reader_progress_cb)(void *handle, void *userdata, vv_mz_zip_file *file_info, int64_t position);
typedef int32_t (*vv_mz_zip_reader_entry_cb)(void *handle, void *userdata, vv_mz_zip_file *file_info, const char *path);
...
typedef int32_t (*vv_mz_zip_writer_overwrite_cb)(void *handle, void *userdata, const char *path);
typedef int32_t (*vv_mz_zip_writer_password_cb)(void *handle, void *userdata, vv_mz_zip_file *file_info, char *password, int32_t max_password);
typedef int32_t (*vv_mz_zip_writer_progress_cb)(void *handle, void *userdata, vv_mz_zip_file *file_info, int64_t position);
typedef int32_t (*vv_mz_zip_writer_entry_cb)(void *handle, void *userdata, vv_mz_zip_file *file_info);
...
int32_t vv_mz_zip_writer_add_path(void *handle, const char *path, const char *root_path, uint8_t include_path,
    uint8_t recursive);
